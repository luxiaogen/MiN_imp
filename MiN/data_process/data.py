...
class iCIFAR224(iData):
    ...
    def data_initialization(self):
        data_path = r'/home/shengqin/fxr/datasets'
...
class iImageNet_A(iData):
    ...
    def data_initialization(self):
        train_dir = r'/home/shengqin/fxr/datasets'
        test_dir = r'/home/shengqin/fxr/datasets'
...
class iCUB200(iData):
    ...
    def data_initialization(self):
        train_dir = r'/home/shengqin/fxr/datasets/CUB_200_2011/train'
        test_dir = r'/home/shengqin/fxr/datasets/CUB_200_2011/test'
        self.category_index, self.train_data = split_img_label(train_dir)
        self.category_index, self.test_data = split_img_label(test_dir)
...
class iImageNet_R(iData):
    ...
    def data_initialization(self):
        train_dir = r'/home/shengqin/fxr/datasets/imagenet-r/train'
        test_dir = r'/home/shengqin/fxr/datasets/imagenet-r/test'
        self.category_index, self.train_data = split_img_label(train_dir)
        self.category_index, self.test_data = split_img_label(test_dir)
